...
const ArrayofBlogs = [
    ...
    },
    {
        ...
        imgURL: "https://img.jakpost.net/c/2019/09/03/2019_09_03_78912_1567484272._large.jpg",
        title: "Nepal not to allow third country nationals to travel to India via rail",
        desc: "As per the latest news reports, Nepal will not be allowing people from third countries to travel to India by rail via the Kurtha-Jayanagar railroad. This move comes after Indian officials expressed security concerns, which was also confirmed by a senior official of the Department of Railways. Referring to this, the Director General of the Department of Railways Deepak Kumar Bhattarai stated, 'This was agreed while finalising the Standard Operating Procedure (SPA) for cross-border railway operation.' The SPA is a document that outlines the procedures that are to be adopted while operating the railway service. Reports have it that India and Nepal signed the SPA in New Delhi last month. As per the Director General of the Department of Railways, India's security concern was one of the reasons why it took so long to finalise the SPA. Reportedly, with India and Nepal sharing a porous border, India has always been cautious about the possibility of miscreants using the porous border to cause harm to India. And reportedly, both sides have suffered a lot from cross-border crimes over the last several years. Further, Bhattarai added that Nepal will now notify India regarding passengers on board to make sure that the security is cleared at the border point. He added that based on the ticket issued, they will then send details of passengers travelling to India. However, although the SPA has already been finalised, it is still not clear when the railway service will start, as the Nepal Government is yet to introduce a law on railway service and the Nepal Railway Company is yet to hire staff to operate the service.",
        category: "Travel",
    ...
    },
    {
        id: 6,
        author: "Balram Kumar",
        imgURL: "https://filmdaily.co/wp-content/uploads/2021/09/venom-lede-1.jpg",
    ...
    },
    {
        id: 9,
        author: "The Times of India",
        imgURL: "https://static.toiimg.com/photo/msid-82830493,width-96,height-65.cms",
        title: "Fully vaccinated visa holders allowed into Australia from December 1",
        desc: "In a latest development, Australia has decided to allow foreign visa holders to enter the country. Prime Minister Scott Morrison said that the country has decided to allow foreign visa holders to enter from December 1. This step has been taken in order to restart international travel, and also support its economy. Much like the rest of the world, Australia too had shut its borders last year, with the spread of the COVID 19. At that time the country only allowed a limited number of permanent residents, and citizens to enter into the country. Eventually, the country had allowed foreign family members of citizens to enter into the country. Now, starting December 1, business visa holders, vaccinated students, and refugees will be permitted to enter. The country has also decided to allow vaccinated tourists from South Korea and Japan to travel from December 1. He said in a statement that allowing skilled workers and students to return to Australia, is a major milestone in getting the country back on its path. The country's foreign students are worth about A$35 billion a year to the economy of the country, and reopening for vaccinated students will be a major step towards getting that economic push for the better. The country is also quite popular as a tourist destination, and has some of the most beautiful beaches. Most notably, the Bondi Beach, which is an iconic beach located in the suburb of Sydney. To reopen such destinations safely would certainly mean the world for travellers!",
        category: "Travel",
    ...
    },
    {
        id: 11,
        author: "Balram Kumar",
        title: "EXCLUSIVE l Vineet Kumar Singh on getting married to his girlfriend of eight years",
        imgURL: "https://images.hindustantimes.com/img/2021/11/30/550x309/a97a29a2-51f3-11ec-b559-3222508970b2_1638286957691.jpg",
        desc: "In times where celebs are not able to hide almost anything from their fans courtesy social media, not only did Vineet Kumar Singh manage to hide his relationship, but he did that for eight years! And on November 29, he got married to his girlfriend Ruchiraa Gormaray in Nagpur.He tells us exclusively, “We know each other from the last eight years, and she has always been with me throughout the journey, the many ups and downs. So we took this call to finally get married. We were planning to originally do this in 2020, but then Covid and the lockdown struck.” The two met in Mumbai for the first time, and hit it off, progressing from friends to partners, and now life partners. The 37-year-old reveals it all ‘grew day by day’, “It was a very intimate affair, with my side and her side of the family, and close friends. We both did the planning, she did more than me, I was always there to support her. The rituals followed were both Maharashtrian and North Indian. It was all in one ceremony.”",
        category: "Bollywood",
        time: " /November 20 2021",
        tags: ["Vineet Kumar Singh", "Ruchiraa Gormaray"],
        readtime: "6 mins read"
    },
    {
        id: 12,
    ...
    },
    {
        id: 13,
        author: "Balram Kumar",
        imgURL: "https://www.nme.com/wp-content/uploads/2018/02/Black-Widow-Avengers-696x442.jpg",
        title: "Black Widow",
        desc: "Natasha Romanoff, a former KGB spy, is shocked to find out that her ex handler, General Dreykov, is still alive. While evading capture by Taskmaster, she is forced to confront her dark past.",
        category: "Hollywood",
...

    {
        id: 18,
        author: "The Times of India",
        imgURL: "https://www.mumbailive.com/images/news/images_1525858231156_bullet_train.jpg?bg=6a724d&crop=1368%2C768%2C0%2C0&fit=fill&fm=webp&h=606.3157894736842&height=768&w=1080&width=1368",
        title: "Delhi to Agra bullet train every hour might turn into a reality by 2029!",
        desc: "Soon the Delhi to Agra high-speed bullet train will turn into a reality! The Delhi-Varanasi High Speed Rail (HSR) is a 958 km long bullet train project that will connect Lucknow with Ayodhya as well. According to the government plan, one bullet train with a top speed of 300 km/hr will connect Delhi to Agra and Agra to Delhi by 2029-30. Prime features of the project. The mammoth project will cost some 2.28 lakh crore and will see a combination of elevated stretches and tunnels for the corridor safety. It would feature 12 stations connecting some major religious destinations including Mathura, Ayodhya, Prayagraj and Varanasi. Not only this, there would also be an underground station at Jewar airport.",
        category: "Travel",
        time: " /November 25, 2021",
        tags: ["Bullet train", "India"],
        readtime: "6 mins read"
    },
    {
        id: 19,
        author: "The Times of India",
        imgURL: "https://static01.nyt.com/images/2018/09/21/world/21india-air-1/merlin_144073263_856e6420-8fce-459f-8168-f213cb3f3c15-jumbo.jpg",
        title: "India to resume scheduled international flights from December 15",
        desc: "India has finally decided to resume operation of international flights from December 15, 2020, after a hiatus of 20 months. However, in view of rising COVID-19 cases in a few countries, the Indian Government is adopting a cautious approach, and barred flights to and from around 14 countries, which include France, the United Kingdom, Netherlands, Germany, South Africa, Finland, Brazil, Bangladesh, China, Botswana, Mauritius, New Zealand, Zimbabwe, and Singapore. However, air bubble arrangements with these countries will continue.",
        category: "Travel",
        time: " /November 27, 2021",
        tags: ["Travel", "India"],
        readtime: "6 mins read"
    },
    {
        id: 20,
        author: "The Times of India",
        imgURL: "https://www.tripsavvy.com/thmb/7k6taYMfXAavW8u55aUZIXR3-G4=/3435x2576/smart/filters:no_upscale()/rue-saint-louis-in-the-upper-town-area-of-historic-old-quebec-quebec-city-quebec-canada-554993579-574d08b83df78ccee110df3b.jpg",
        title: "Canada has become the latest country to approve India-made Covaxin, which means that it those jabbed with Covaxin will now be allowed entry, provided they follow the guidelines laid. Firstly, those intending to travel to Canada should be fully-vaccinated as well. The permission to allow travellers jabbed with Covaxin will come into effect from November 30. An important fact to remember is that the second dose of vaccine must be taken by travellers at least 14 days before their arrival in Canada. The decision was announced by the Public Health Agency of Canada, stating that, 'Beginning Nov 30, the #GOC will expand its list of #Covid19 vaccines accepted for entry to Canada to include Sinopharm, Sinovac and COVAXIN. Travellers must have received a full vaccine series at least 14 days before entry to Canada.' Last week, Canada announced an expansion of its list of approved COVID-19 vaccines, bringing in respite for a large number of travellers who have been wanting to visit the nation. India, of course, is home to a high number of people who have ties with Canada, who have been eagerly awaiting such a decision.",
        category: "Travel",
        time: " /November 28, 2021",
        tags: ["TRAVEL NEWS", "CANADA"],
        readtime: "6 mins read"
    },
    {
        id: 21,
        author: "The Times of India",
        imgURL: "https://e3.365dm.com/21/11/2048x1152/skynews-omicron-covid-coronavirus_5600173.jpg",
        title: "Omicron scare: Israel and Japan shut their borders to foreign travellers",
        desc: "Israel has become the first country in the world to shut its borders for foreign travellers owing to the Omicron scare. Soon after, Japan followed suit and barred foreign travellers from entering into the country. A number of countries have reported confirmed or suspected cases of the Omicron, the new variant of COVID-19. The new variant has already been discovered in Australia, Botswana, Britain, Belgium, Canada, Denmark, France, Germany, Hong Kong, Israel, Italy, the Netherlands and Scotland. Israel has not only banned entry of foreigners but has also made quarantine for all Israelis arriving from abroad mandatory. Israeli Prime Minister Naftali Bennett said, 'Restrictions on the country's borders is not an easy step, but it's a temporary and necessary step. 'The government of Japan also said that they would shut its borders to foreigners amid rising cases of the Omicron variant of Coronavirus. Japanese Prime Minister Fumio Kishida said that he is ready to take criticism for being too cautious.",
        category: "Travel",
        time: " /November 30, 2021",
        tags: ["TRAVEL NEWS", "WORLD"],
        readtime: "6 mins read"
    },
    {
        id: 22,
        author: "Balram Kumar",
        imgURL: "https://www.analyticsinsight.net/wp-content/uploads/2021/06/Big-Data-3.jpg",
        title: "big data analytics",
        desc: "Big data analytics is the use of advanced analytic techniques against very large, diverse data sets that include structured, semi-structured and unstructured data, from different sources, and in different sizes from terabytes to zettabytes. Big data is a term applied to data sets whose size or type is beyond the ability of traditional relational databases to capture, manage and process the data with low latency. Big data has one or more of the following characteristics: high volume, high velocity or high variety. Artificial intelligence (AI), mobile, social and the Internet of Things (IoT) are driving data complexity through new forms and sources of data. For example, big data comes from sensors, devices, video/audio, networks, log files, transactional applications, web, and social media — much of it generated in real time and at a very large scale. Analysis of big data allows analysts, researchers and business users to make better and faster decisions using data that was previously inaccessible or unusable. Businesses can use advanced analytics techniques such as text analytics, machine learning, predictive analytics, data mining, statistics and natural language processing to gain new insights from previously untapped data sources independently or together with existing enterprise data.",
        category: "Technology",
        time: " /November 14, 2021",
    ...
    },
    {
        id: 24,
        author: "Shubham Kumar",
        imgURL: "https://13p13n407tzq3x5jwg1daxox-wpengine.netdna-ssl.com/wp-content/uploads/2015/04/what-is-a-responsive-website.png",
        title: "The future of responsive design",
        desc: "When you think of the term responsive design, what comes to mind? Is it mobile devices versus desktop devices? Is it designing in a way that works across screen sizes? Thinking about mobile touch versus using a mouse? Is it components changing shape based on where they are laid out on the page? That might be how we used to think about responsive design, but it’s definitely not all there is to it. And the way that we can, and should, be thinking about responsive design is how responsive design affects a user’s context and how we can be the most responsive to the user’s needs and experience. Screen size is a small part of that context, but so are these elements when the user is accessing your application: The user’s location. The light level and noise level. The time (including timezone) of where they currently are. How they are holding the device, and how they best access their device (personal settings on that device). The future of responsive design is a user’s context in space and time, their devices context in space and time, and the user’s preferences on said devices in space and time. It’s all of these things. Today’s web browsers we access and develop for give us the power to leverage these inputs in our designs. We can now access the location, light level or light preference, orientation, and battery-level of a device, and make design choices around these elements.",
        category: "Technology",
